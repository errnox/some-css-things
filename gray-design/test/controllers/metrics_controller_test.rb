...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post :create, metric: { active: @metric.active, description: @metric.description, name: @metric.name, value: @metric.value }
    end
  ...
  test "should update metric" do
    patch :update, id: @metric, metric: { active: @metric.active, description: @metric.description, name: @metric.name, value: @metric.value }
    assert_redirected_to metric_path(assigns(:metric))
  end
